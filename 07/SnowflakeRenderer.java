...
public class SnowflakeRenderer {
	...
	private int horizontalMovement = 10;
	private int verticalMovement = 3;
	...
	private void createNewSnowflakes(Graphics2D g) {
		for (int i = 0; i < this.snowflakeIncreaseRate; i++) {
			...
			Snowflake s = new Snowflake(this.levelOfDetail, this.snowflakeSize, xPosSnowflake, this.gravity, g, this.frameHeight, this.horizontalMovement, this.verticalMovement);
